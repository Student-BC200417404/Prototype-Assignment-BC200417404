    ...
    <div class="card basic-data-table">
                ...
                <div class="d-flex gap-2">
                    <div class="btn-group" role="group">
                        <a href="{{ route('admin.orders.index') }}" 
                           class="btn btn-sm {{ request()->routeIs('admin.orders.index') ? 'btn-primary' : 'btn-outline-primary' }}">
                            All Orders
                        </a>
                        <a href="{{ route('admin.orders.pending') }}" 
                           class="btn btn-sm {{ request()->routeIs('admin.orders.pending') ? 'btn-primary' : 'btn-outline-primary' }}">
                            Pending
                        </a>
                        <a href="{{ route('admin.orders.completed') }}" 
                           class="btn btn-sm {{ request()->routeIs('admin.orders.completed') ? 'btn-primary' : 'btn-outline-primary' }}">
                            Completed
                        </a>
                    </div>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-striped datatable" data-url="{{ route('admin.orders.data') }}">
                    <thead>
                        <tr>
                            <th width="50">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Update status for <span id="selectedCount">0</span> selected orders:</p>
                <div class="form-check">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="bulkStatus" id="statusProcessing" value="processing">
...
$(document).ready(function() {
        ...
        columns: [
            {
                ...
                render: function(data, type, row) {
                    return `<div class="form-check">
                                <input class="form-check-input order-checkbox" type="checkbox" value="${row.id}">
                            </div>`;
                }
            },
    ...
    $('#bulkDeleteBtn').on('click', function() {
        ...
        Swal.fire({
            title: 'Are you sure?',
            text: `You want to delete ${selectedIds.length} order(s)? This action cannot be undone.`,
            icon: 'warning',
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        Swal.fire({
                            icon: 'success',
                            title: 'Deleted!',
                            text: response.message || 'Orders deleted successfully!',
                            timer: 2000,
                            showConfirmButton: false
                        });
                    },
