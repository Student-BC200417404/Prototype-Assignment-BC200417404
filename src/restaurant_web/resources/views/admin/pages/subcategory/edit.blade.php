        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="mb-0">Edit Subcategory: {{ $subcategory->name }}</h4>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-md-6">
                                <h4 class="card-title mb-0">Edit Subcategory Information</h4>
                            </div>
                    ...
                    <div class="card-body">
                        <form id="subcategory-form" action="{{ route('admin.subcategories.update', $subcategory->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" class="form-control @error('display_order') is-invalid @enderror" 
                                                       ...
                                                       value="{{ old('display_order', $subcategory->display_order ?? 0) }}" 
                                                       min="0" placeholder="0">
                                                @error('display_order')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <div class="dropzone-wrapper">
                                            <div class="dropzone" id="image-dropzone" style="{{ $subcategory->image ? 'display: none;' : '' }}">
                                        ...
                                        <!-- Image Preview -->
                                        <div id="image-preview" class="mt-3" style="{{ $subcategory->image ? '' : 'display: none;' }}">
                                            <img id="preview-img" src="{{ $subcategory->image ? asset('storage/subcategories/' . $subcategory->image) : '' }}" 
...
$(document).ready(function() {
    ...
    $('#subcategory-form').on('submit', function(e) {
        ...
        $('#submit-btn').prop('disabled', true).html('<i class="ri-loader-4-line align-middle me-1"></i> Updating...');
        ...
        $.ajax({
            ...
            complete: function() {
                ...
                $('#submit-btn').prop('disabled', false).html('<i class="ri-save-line align-middle me-1"></i> Update Subcategory');
            }
        });
    });

    // Real-time name validation (skip current subcategory)
