...
$(document).ready(function() {
    ...
    $('#bulk-delete-btn').on('click', function() {
        ...
        if (selectedIds.length === 0) {
            Swal.fire('Warning', 'Please select at least one subcategory to delete.', 'warning');
            return;
        }

        Swal.fire({
            title: 'Are you sure?',
            text: 'You are about to delete ' + selectedIds.length + ' subcategory(ies). This action cannot be undone!',
            icon: 'warning',
            ...
            if (result.isConfirmed) {
                $.ajax({
                    ...
                    error: function() {
                        Swal.fire('Error!', 'An error occurred while deleting subcategories.', 'error');
                    }
                });
            }
        });
    ...
    $(document).on('click', '.delete-btn', function(e) {
        ...
        Swal.fire({
            title: 'Are you sure?',
            text: 'You are about to delete subcategory "' + name + '". This action cannot be undone!',
            icon: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#d33',
            cancelButtonColor: '#3085d6',
    ...
    $(document).on('click', '.toggle-status', function(e) {
        ...
        $.ajax({
            url: '/admin/subcategories/' + id + '/toggle-status',
            type: 'PATCH',
            data: {
                _token: '{{ csrf_token() }}'
            },
